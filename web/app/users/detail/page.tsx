  ...
  return (
    <>
          ...
          <table className="w-full border-collapse">
            <tbody>
              ...
              <tr>
                ...
                <td className="py-2 px-3">{new Date(user.created_at).toISOString().slice(0, 16).replace("T", " ")} UTC</td>
              </tr>
            </tbody>
          </table>
        </TableWrap>
      ...
      <Panel>
        ...
        <Label>Type</Label>
        <Input value={credType} onChange={(e) => setCredType(e.target.value)} placeholder="card, face_2d, face_3d, fingerprint" />
